...
var fileMax = 3;
$('#multi_upload').after('<div id="files_list" style="border:1px solid #976B00;padding:5px;background:none;font-size:x-small;"><strong>Files (maximum '+fileMax+'):</strong></div>');
...
$(obj).hide();
$(obj).parent().prepend('<input type="file" class="upload" name="images[]" size="60" />').find("input").change(function() {doIt(this, fm)});
var v = obj.value;
if(v != '') {
$("div#files_list").append('<div>'+v+'<input type="button" class="remove submit_button" value="Delete" style="width: 70px;"/></div>')
     ...
     <div id="container">
		...
		**************************************************************************************************************************/
		  ...
		  switch ($action) {
			...
			case 'create-mail':
			  display_mail_form2($admin_email);
			break;
