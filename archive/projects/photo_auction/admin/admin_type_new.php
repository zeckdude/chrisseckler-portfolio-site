...
error_reporting(E_ALL ^ E_NOTICE ^ E_DEPRECATED);
	...
	if (array_key_exists('insert', $_POST)) { 
		...
		$sql = 'INSERT INTO types (types.type_name, types.type_desc)
				VALUES(?, ?)';
...
<div id="container">
    ...
    <div id="main_content">
        <div id="highest_items">
            <h2 style="margin-left: 0px;">Enter new Type of Print Information </h2>
                <form id="fill_out_form" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                    <p>
                        <label for="name">Type Name:</label>
                        <input name="name" type="text" id="type_name" value=""/></input>
                    </p>
                    
                    <p>
                        <label for="desc">Type Description:</label>
                        <textarea name="desc" id="type_desc"/></textarea>
                    </p>

                    <p>
                        <input type="submit" name="insert" value="Insert new Type Information" />
                    </p>
        		</form> 
