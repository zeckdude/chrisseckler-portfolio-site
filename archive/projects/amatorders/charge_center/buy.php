...
<html>
	<head>
		...
		<script type="text/javascript">
			Stripe.setPublishableKey('pk_074Uv0C4yYS3elTQtKpYgjs5mL8Yh');	// Test key!
		</script>
	...
	<body>
		...
		<form id="buy-form" method="post" action="javascript:">
			...
			<p class="form-label">Amount to Charge:</p>
			<input class="text" id="charge-amount" autocomplete="off"></input>
			
			<input id="buy-submit-button" type="submit" value="Charge the Card"></input>
		</form>
	</body>
</html>