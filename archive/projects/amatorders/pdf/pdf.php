...
$name = utf8_decode($_SESSION["full_name"]);
//$name = $_SESSION["full_name"];

$title = utf8_decode($_SESSION["title"]);

$title_2 = utf8_decode($_SESSION["title_2"]);

$dept_div = utf8_decode($_SESSION["dept_div"]);

$dept_div_2 = utf8_decode($_SESSION["dept_div_2"]);


$_SESSION["full_name"] = trim($_SESSION["full_name"]); //trim the whitespace off the beginning and end

//$fullName = stripslashes($_SESSION['full_name']);
...
$custom_address_line_1 = $_SESSION[custom_address_1]. $mail_stop;
...
if($_SESSION[foreign_cards_ordered] == 'yes' && $_SESSION[english_cards_ordered] == 'yes') { //If both English and Foreign Cards are ordered

	// Main side for English Only Card
	...
	$pdf->Cell(0,4, stripslashes($name), '0', 2, 'L', false); //Full Name

	

	$pdf->SetFont('Whitney-BookItalic','',7.25);

	$pdf->Cell(0,2.5,  stripslashes($title), '0', 2, 'L', false); //Title

	

	if($title_2) {

		$pdf->Cell(0,2.5,  stripslashes($title_2), '0', 2, 'L', false); //Title 2
	...
	if($dept_div) {
		...
		$pdf->Cell(0,2.5,  stripslashes($dept_div), '0', 2, 'L', false); //Department
	...
	if($dept_div_2) {
		...
		$pdf->Cell(0,2.5,  stripslashes($dept_div_2), '0', 2, 'L', false); //Department 2
	...
	} else if($_SESSION[phone_symbol] == 'C') {

		$pdf->Cell(3,2.5, "C  ", '0', 0, 'L', false); //Phone Signifier

	} else if($_SESSION[phone_symbol] == 'M') {

		$pdf->Cell(3,2.5, "M  ", '0', 0, 'L', false); //Phone Signifier
	...
	$pdf->Cell(0,3,  stripslashes($email), '0', 2, 'L', false); //Email
	...
	if($_SESSION['location'] == 'us_address') {
		...
		if($_SESSION['address'] != 0) {
			...
			$pdf->Cell(0,2.5,  stripslashes($address_line_1), '0', 2, 'L', false); //Address Line 1

			if(isset($address_line_2)) {

				$pdf->Cell(0,2.5,  stripslashes($address_line_2), '0', 2, 'L', false); //Address Line 2

			}

			$pdf->Cell(0,2.5,  stripslashes($address_line_3), '0', 2, 'L', false); //Address Line 3

		} else if($_SESSION['other_address'] == 'yes') {

			$pdf->Cell(0,2.5,  stripslashes($custom_address_line_1), '0', 2, 'L', false); //Address Line 1

			if(isset($custom_address_line_2)) {

				$pdf->Cell(0,2.5,  stripslashes($custom_address_line_2), '0', 2, 'L', false); //Address Line 2

			}

			$pdf->Cell(0,2.5,  stripslashes($custom_address_line_3), '0', 2, 'L', false); //Address Line 3
		...
		if($_SESSION['no_address'] == 'no') {
			...
			$pdf->Cell(0,2.5,  stripslashes($_SESSION['non_us_address_1']), '0', 2, 'L', false); //Address Line 1

			if(isset($_SESSION['non_us_address_2'])) {

				$pdf->Cell(0,2.5,  stripslashes($_SESSION['non_us_address_2']), '0', 2, 'L', false); //Address Line 2

			}

			if(isset($_SESSION['non_us_address_3'])) {

				$pdf->Cell(0,2.5,  stripslashes($_SESSION['non_us_address_3']), '0', 2, 'L', false); //Address Line 2

			}

			if(isset($_SESSION['non_us_address_4'])) {

				$pdf->Cell(0,2.5,  stripslashes($_SESSION['non_us_address_4']), '0', 2, 'L', false); //Address Line 2
	...
	if($_SESSION['location'] == 'us_address') {
		...
		if($_SESSION['address'] != 0) {
			...
			$pdf->Cell(0,2.5,  stripslashes($address_line_3) . ' USA', '0', 2, 'L', false); //Address Line 3
...
} else if($_SESSION[foreign_cards_ordered] == 'no' && $_SESSION[english_cards_ordered] == 'yes') { //If only English Cards are ordered
...
} else if($_SESSION[foreign_cards_ordered] == 'yes' && $_SESSION[english_cards_ordered] == 'no') { //If only Foreign Cards are ordered
