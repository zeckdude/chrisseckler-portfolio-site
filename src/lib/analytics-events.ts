...
export const ANALYTICS_EVENTS = [
  ...
  {
    name: "archive viewed",
    where: "src/app/archive/page.tsx — ArchiveViewTracker",
    when: "Visitor opens /archive",
  },
  {
    name: "archive launched",
    where: "src/components/archive/archive-card.tsx",
    when: 'Visitor clicks "Launch archived site" (opens subdomain in new tab)',
  },
] as const;
