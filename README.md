...
| Repo | Purpose |
|---|---|
| **This repo** (`chrisseckler-portfolio-site`) | Live site at [chrisseckler.com](https://chrisseckler.com) |
| [`chrisseckler-portfolio-archives`](https://github.com/zeckdude/chrisseckler-portfolio-archives) | Frozen past portfolios on `YYYY.archive.chrisseckler.com` |

The 2024 Express/Nunjucks source is preserved on git tag `archive-2024-express` in this repo’s history.
